...
func (h *RequestStruct) ParseRequest(r *http.Request) error {
	...
	if err := tools.GroupError("path", func() error { return tools.ParseInt("Id", r.PathValue("id"), &h.Id) },
		func() error { return tools.ParseUInt("Operation", r.PathValue("operation"), &h.Operation) }); err != nil {
		return err
	}

	if err := tools.GroupError("headers", func() error {
		...
		func() error { return tools.ParseUInt8("NumberByte", r.Header.Get("number_byte"), &h.NumberByte) }); err != nil {
		return err
	}

	if err := tools.GroupError("query", func() error {
		...
		func() error { return tools.ParseUInt64("NumberBig", r.URL.Query().Get("number_big"), &h.NumberBig) }); err != nil {
		return err
	}
